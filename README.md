WeCars is an add on package to the Webots Robotics Simulation Software. 
WeCars enables higher fidelity vehicle dynamics simulation than offered in Webots by default.
